...
public class BorrowCardServiceImpl implements BorrowCardService {
    ...
    public boolean update(BorrowCard borrowCard) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("Lỗi update BorrowCard: " + e.getMessage());
        }
        return false;
    }
    ...
    public BorrowCard getById(Long borrowId) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("Lỗi getById BorrowCard: " + e.getMessage());
        }
        return null;
    }
    ...
    public List<BorrowCard> getAll() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("Lỗi getAll BorrowCard: " + e.getMessage());
        }
        return list;
    }

    @Override
    public List<BorrowCard> searchBorrowing(String bookName, String studentName) {
        List<BorrowCard> list = new ArrayList<>();
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("Lỗi searchBorrowing BorrowCard: " + e.getMessage());
        }
        return list;
    }
}